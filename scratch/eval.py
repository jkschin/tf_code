...
Accuracy:
combined_train.py achieves 83.0% accuracy after 100K steps (256 epochs
of data) as judged by combined_eval.py.

Speed:
On a single Tesla K40, combined_train.py processes a single batch of 128 images
...
http://tensorflow.org/tutorials/deep_combined/
"""
...
def eval_once(saver, summary_writer, top_k_op_batch, top_k_op_single, labels, summary_op):
  ...
  with tf.Session() as sess:
    ...
    if ckpt and ckpt.model_checkpoint_path:
      ...
      #   /my-favorite-path/combined_train/model.ckpt-0,
